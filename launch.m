...
%     scenario = CombinedGoToGoalVectorScenario(SmoothDifferentialDriveVehicle, VECTOR_FOLLOWING_TYPE.POINT );
%     scenario = CombinedGoToGoalOrbitAvoidScenario(SmoothDifferentialDriveVehicle, VECTOR_FOLLOWING_TYPE.POINT );
    scenario = CombinedGoToGoalOrbitAvoidWithBarrierScenario(SmoothDifferentialDriveVehicle, VECTOR_FOLLOWING_TYPE.POINT );
...
%     scenario = SwithingLineScenarioObstacleAvoidBetterSwitch(SmoothDifferentialDrive, VECTOR_FOLLOWING_TYPE.POINT );   
